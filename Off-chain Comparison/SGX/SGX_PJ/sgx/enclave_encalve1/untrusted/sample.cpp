...
int initialize_enclave(void)
{
    ...
    ret = sgx_create_enclave(ENCALVE1_FILENAME, SGX_DEBUG_FLAG, NULL, NULL, &global_eid, NULL);
...
/* OCall functions */
void ocall_encalve1_sample(const char *str)
{
...
int SGX_CDECL main(int argc, char *argv[])
{
    ...
    for (int i = 0; i <1000;i++) {
        	ecall_encalve1_sample(global_eid, &ecall_return, a);
    }*/

    ret = ecall_encalve1_sample(global_eid, &ecall_return, a);
    if (ret != SGX_SUCCESS)
        abort();
