...
$(UNTRUSTED_DIR)/encalve1_u.c: $(SGX_EDGER8R) $(TRUSTED_DIR)/encalve1.edl
	@cd $(UNTRUSTED_DIR) && $(SGX_EDGER8R) --untrusted ../$(TRUSTED_DIR)/encalve1.edl --search-path ../$(TRUSTED_DIR) --search-path $(SGX_SDK)/include
	@echo "GEN  =>  $@"

$(UNTRUSTED_DIR)/encalve1_u.o: $(UNTRUSTED_DIR)/encalve1_u.c
	@$(CC) $(App_C_Flags) -c $< -o $@
	@echo "CC   <=  $<"
...
sample: $(UNTRUSTED_DIR)/encalve1_u.o $(App_Cpp_Objects)
...
clean:
	@rm -f sample  $(App_Cpp_Objects) $(UNTRUSTED_DIR)/encalve1_u.* 
